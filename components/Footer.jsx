...
const Footer = () => {
  return (
    <div className="w-full py-20 px-4 md:px-0 bg-[#0f4189]">
      <div className="w-full max-w-6xl mx-auto">
        <div className="w-full grid grid-cols-12 gap-10">
          <div className="col-span-12 md:col-span-6 pr-8">
            <p className="text-[#ff793f] text-lg font-bold flex items-center gap-2">
              {" "}
              <span>
            ...
            <p className="text-sm text-gray-200 pt-2">
              Tech Weekly is a platform that brings you the latest news about technology, AI, software, startups, and more.
            </p>
            <div className="pt-8">
              <p className="text-sm text-gray-200 pt-2">Follow us on social media</p>
              <div>
          ...
          <div className="col-span-12 md:col-span-3 pr-8 pt-2">
          ...
          <div className="col-span-12 md:col-span-3 pr-8 pt-2">
            <ul className="flex flex-col space-y-2">
              <Link href="/">
                <li className="text-sm text-slate-100 ">Terms of Service</li>
              </Link>
              <Link href="/">
                <li className="text-sm text-slate-100 ">Privacy Policy</li>
              </Link>
              <Link href="/">
                <li className="text-sm text-slate-100 ">Code of Conduct</li>
              </Link>
              <Link href="/">
                <li className="text-sm text-slate-100 ">About Our Ads</li>
              </Link>
            </ul>
          </div>
        </div>
      ...
      <div className="w-full max-w-6xl mx-auto pt-10">
        <p className="text-slate-50 text-[12px]"> &copy; {fullYear}</p>
      </div>
    </div>
  );
};
